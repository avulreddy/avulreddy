<%--
  ...
  @version $Id: //product/AssetUI/version/9.1/src/web-apps/AssetManager/assetEditor/property/bigStringEditor.jsp#1 $$Change: 531151 $
  @updated $DateTime: 2009/04/03 20:49:48 $$Author: rbarbier $
  --%>
...
<dspel:page>
  ...
  <dspel:textarea id="${inputId}"
                  ...
                  bean="${propertyView.formHandlerProperty}" style="height: 50px;"/>
