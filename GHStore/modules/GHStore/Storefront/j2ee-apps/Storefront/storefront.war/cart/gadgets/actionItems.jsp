...
<dsp:page>
  ...
  <dsp:importbean bean="/atg/commerce/order/purchase/PaypalCartFormHandler"/>
  ...
  <div class="atg_store_cartActions">
    ...
    <span class="atg_store_basicButton">
          <fmt:message var="checkoutText" key="common.button.checkoutText"/>
          <dsp:input id="atg_store_checkout" type="submit" bean="PaypalCartFormHandler.expressCheckoutWithPayPal" value="Paypal"/>
    </span>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Storefront/j2ee/store.war/cart/gadgets/actionItems.jsp#1 $$Change: 875535 $--%>
