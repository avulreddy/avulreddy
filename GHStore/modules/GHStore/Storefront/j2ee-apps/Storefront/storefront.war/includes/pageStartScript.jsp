...
<dsp:page>
  ...
  <script type="text/javascript" src="${javascriptRoot}/jquery-1.7.1.min.js"></script>
  <script type="text/javascript" src="${javascriptRoot}/checkout.js"></script>
  <%-- 
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Storefront/j2ee/store.war/includes/pageStartScript.jsp#3 $$Change: 884492 $--%>
