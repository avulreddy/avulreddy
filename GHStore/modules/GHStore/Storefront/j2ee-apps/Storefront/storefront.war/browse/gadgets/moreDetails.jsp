  ...
  <div class="atg_store_productDescription">
    ...
    <c:if test="${not empty giftWrapMessage}">
      <div id="gift_wrap_not_eligible">
	   ...
	   <dsp:droplet name="/atg/commerce/utils/droplet/FindModuleDroplet">
	   <dsp:param name="moduleName" value="BazaarVoice"/>
	   <dsp:oparam name="output">
	    <dsp:getvalueof param="isModuleExist" var="moduleRunning"/> 
	   <c:if test="${moduleRunning}">
			 <dsp:include page="/bazaarvoice/ratings.jsp">
			 	 <dsp:param name="ratingProductId" param="product.id"/>
		    </dsp:include>
		</c:if>
	   </dsp:oparam>
	   </dsp:droplet>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Storefront/j2ee/store.war/browse/gadgets/moreDetails.jsp#1 $$Change: 875535 $ --%>
