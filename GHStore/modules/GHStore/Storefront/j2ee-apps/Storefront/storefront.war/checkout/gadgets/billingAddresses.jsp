        ...
        <dl class="atg_store_billingAddresses atg_store_savedAddresses">
          <dt>
            ...
            <dsp:input type="radio" name="address" value="${shippingGroupNickname}" 
                       ...
                       bean="${formHandler}.storedAddressSelection"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Storefront/j2ee/store.war/checkout/gadgets/billingAddresses.jsp#1 $$Change: 875535 $--%>
