      ...
      <dsp:droplet name="RepriceOrderDroplet">
		...
		<dsp:droplet name="/atg/commerce/utils/droplet/FindModuleDroplet">
			...
			<dsp:oparam name="output"> --%>
				<dsp:getvalueof var="isBMLExists" value="true"></dsp:getvalueof>
			</dsp:oparam>
		</dsp:droplet>

		
 	 <c:if test="${isBMLExists}">
	      	<dsp:setvalue bean="/atg/store/order/purchase/BMLBillingFormHandler.updateBMLPayment" value="updateBml"/>
      </c:if>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Storefront/j2ee/store.war/checkout/confirm.jsp#1 $$Change: 875535 $--%>
